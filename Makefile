...
#    Updated: 2025/02/12 18:07:42 by mez-zahi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = mandatory/afficher_pile.c mandatory/case_grand_pile.c mandatory/chker_erreur.c mandatory/concat_arg.c \
...
SRCS_COMMUN = mandatory/afficher_pile.c mandatory/case_grand_pile.c mandatory/chker_erreur.c mandatory/concat_arg.c \
		mandatory/creat_pile.c  mandatory/free.c mandatory/init_pile.c mandatory/lis.c mandatory/move_pile.c \
